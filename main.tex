...
% - Illustrate with example: rotated ship detected with huge HBB → lots of background included
% - High overlap between HBBs → NMS removes correct detections
% - Quantitative argument: IoU drops significantly for rotated objects with HBB
